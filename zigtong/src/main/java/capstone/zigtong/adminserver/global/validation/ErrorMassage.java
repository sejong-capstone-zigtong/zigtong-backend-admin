...
public class ErrorMassage {
    public final static String EMPTY_ACCOUNT = "아이디를 입력해주세요.";
    ...
    //회원가입
    public final static String INVALID_ACCOUNT =
            "아이디는 영문 소문자와 숫자로 이루어진 " + ACCOUNT_MIN_LENGTH + "자 이상, " + ACCOUNT_MAX_LENGTH
                    + "자 이하로 이루어져야 합니다.";
